...
const ProductInstrumentationComponents = lazy(
  () => import("@/pages/product-categories/instrumentation-components"),
);
const ProductElectricalComponents = lazy(
  () => import("@/pages/product-categories/electrical-components"),
);
const ProductMeasurementInstruments = lazy(
  () => import("@/pages/product-categories/measurement-instruments"),
);
const ProductSolarProducts = lazy(
  () => import("@/pages/product-categories/solar-products"),
);
const ProductAutomationControlSystems = lazy(
  () => import("@/pages/product-categories/automation-control-systems"),
);
const ProductSafetyProtectiveDevices = lazy(
  () => import("@/pages/product-categories/safety-protective-devices"),
);
const ProductMechanicalPumpsSpares = lazy(
  () => import("@/pages/product-categories/mechanical-pumps-spares"),
);
const ProductIndustrialToolsTackles = lazy(
  () => import("@/pages/product-categories/industrial-tools-tackles"),
);
      ...
      <Suspense fallback={<LoadingSpinner />}>
        <Switch>
          ...
          <Route
            ...
            component={ProductInstrumentationComponents}
          />
          <Route
            path="/products/electrical-components"
            component={ProductElectricalComponents}
          />
          <Route
            path="/products/measurement-instruments"
            component={ProductMeasurementInstruments}
          />
          <Route
            path="/products/solar-products"
            component={ProductSolarProducts}
          />
          <Route
            path="/products/automation-control-systems"
            component={ProductAutomationControlSystems}
          />
          <Route
            path="/products/safety-protective-devices"
            component={ProductSafetyProtectiveDevices}
          />
          <Route
            path="/products/mechanical-pumps-spares"
            component={ProductMechanicalPumpsSpares}
          />
          <Route
            path="/products/industrial-tools-tackles"
            component={ProductIndustrialToolsTackles}
          />
          ...
          <Route
            ...
            />
          <Route
            path="/products/hmi-panel-mount"
            component={hmiPanelMount}
            />
          <Route
          ...
          <Route
            ...
            />
          <Route
            path="/products/scada-ge-ifix"
            component={scadaGeIfix}
            />
          <Route
