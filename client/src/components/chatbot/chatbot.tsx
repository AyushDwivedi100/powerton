    ...
    if (isOpen && isInitialized && messages.length === 0) {
      setTimeout(() => {
        addBotMessage({
          ...
          options: [
            { label: t('chatbot.options.findProduct'), action: "chat", response: "product-selection" },
            { label: t('chatbot.options.chooseService'), action: "chat", response: "service-selection" },
            { label: t('chatbot.options.troubleshooting'), action: "chat", response: "troubleshooting" },
            { label: t('chatbot.options.aboutCompany'), action: "chat", response: "company-info" }
          ]
        });
      }, 500);
    }
  ...
  const generateResponse = (userInput: string): ChatbotResponse => {
    ...
    if (input === 'product-selection') {
      return {
        ...
        options: [
          { label: t('chatbot.options.sensorsCategory'), action: "chat", response: "sensors-category" },
          { label: t('chatbot.options.electricalCategory'), action: "chat", response: "electrical-category" },
          { label: t('chatbot.options.automationCategory'), action: "chat", response: "automation-category" },
          { label: t('chatbot.options.solarCategory'), action: "chat", response: "solar-category" },
          { label: t('chatbot.options.safetyCategory'), action: "chat", response: "safety-category" },
    ...
    if (input === 'service-selection') {
      return {
        ...
        options: [
          { label: t('chatbot.options.installationService'), action: "chat", response: "installation-service" },
          { label: t('chatbot.options.maintenanceService'), action: "chat", response: "maintenance-service" },
          { label: t('chatbot.options.calibrationService'), action: "chat", response: "calibration-service" },
          { label: t('chatbot.options.trainingService'), action: "chat", response: "training-service" },
          { label: t('chatbot.options.solarService'), action: "chat", response: "solar-service" },
          { label: t('chatbot.options.viewAllServices'), action: "page", page: "services" },
    ...
    if (input === 'troubleshooting') {
      return {
        ...
        options: [
          { label: t('chatbot.options.electricalIssues'), action: "chat", response: "electrical-troubleshooting" },
          { label: t('chatbot.options.sensorProblems'), action: "chat", response: "sensor-troubleshooting" },
          { label: t('chatbot.options.controlSystemIssues'), action: "chat", response: "control-troubleshooting" },
          { label: t('chatbot.options.solarSystemProblems'), action: "chat", response: "solar-troubleshooting" },
          { label: t('chatbot.options.equipmentSelectionHelp'), action: "chat", response: "selection-help" },
    ...
    if (input === 'company-info') {
      return {
        ...
        options: [
          { label: t('chatbot.options.ourAchievements'), action: "chat", response: "achievements" },
          { label: t('chatbot.options.meetOurTeam'), action: "page", page: "about" },
          { label: t('chatbot.options.ourClients'), action: "chat", response: "client-testimonials" },
          { label: t('chatbot.options.visitOurOffice'), action: "external", url: "https://maps.app.goo.gl/jiap3sBYbM3r8Pn68" },
          { label: t('chatbot.options.contactUs'), action: "external", url: "tel:+91-94627-71662" },
          { label: t('chatbot.options.backToMainMenu'), action: "chat", response: "main-menu" }
        ]
      };
    }
    ...
    if (input.includes('quote') || input.includes('price') || input.includes('cost') || input.includes('estimate') || input.includes('budget')) {
      return {
        ...
        options: [
          ...
          { label: "📧 Email Requirements", action: "external", url: "mailto:info@powertonengineering.com?subject=Quote Request" },
          { label: "💰 Pricing Information", action: "chat", response: "pricing-info" },
          { label: "🎯 Custom Solution", action: "external", url: "mailto:info@powertonengineering.com?subject=Custom Solution Request" }
        ]
      };
    }
    ...
    if (input === 'business-hours') {
      return {
        ...
        options: [
          ...
          { label: "📧 Email Anytime", action: "external", url: "mailto:info@powertonengineering.com" },
          { label: "🗺️ Visit Our Office", action: "external", url: "https://maps.app.goo.gl/jiap3sBYbM3r8Pn68" },
          { label: "⚡ Emergency Support", action: "external", url: "tel:+91-94627-71662" },
          { label: "📅 Schedule Meeting", action: "external", url: "mailto:info@powertonengineering.com?subject=Meeting Request" }
        ]
      };
    }
    ...
    if (input === 'pricing-info') {
      return {
        ...
        options: [
          ...
          { label: "📧 Email Requirements", action: "external", url: "mailto:info@powertonengineering.com?subject=Pricing Inquiry" },
    ...
    if (input === 'main-menu') {
      return {
        ...
        options: [
          ...
          { label: "💼 About Our Company", action: "chat", response: "company-info" },
          { label: "📞 Speak with Expert", action: "external", url: "tel:+91-94627-71662" },
          { label: "📧 Send Us a Message", action: "external", url: "mailto:info@powertonengineering.com" }
        ]
      };
    }
    ...
    if (input === 'quote-tips') {
      return {
        ...
        options: [
          ...
          { label: "📧 Email Specifications", action: "external", url: "mailto:info@powertonengineering.com?subject=Detailed Quote Request" },
          { label: "💰 Pricing Information", action: "chat", response: "pricing-info" },
    ...
    if (input === 'urgent-support') {
      return {
        ...
        options: [
          ...
          { label: "⚡ Emergency Email", action: "external", url: "mailto:info@powertonengineering.com?subject=URGENT - Emergency Support Required" },
      ...
      const pageResponses: { [key: string]: ChatbotResponse } = {
        'products': {
          ...
          options: [
            ...
            { label: "💰 Get Product Quote", action: "external", url: "mailto:info@powertonengineering.com?subject=Product Quote Request" },
            { label: "📞 Technical Consultation", action: "external", url: "tel:+91-94627-71662" },
        ...
        'services': {
          ...
          options: [
            ...
            { label: "📋 Service Quote", action: "external", url: "mailto:info@powertonengineering.com?subject=Service Quote Request" },
            { label: "🏠 Back to Main Menu", action: "chat", response: "main-menu" }
          ]
        },
        'contact': {
          ...
          options: [
            ...
            { label: "📧 Send Email", action: "external", url: "mailto:info@powertonengineering.com" },
        ...
        'projects': {
          ...
          options: [
            { label: "💡 Discuss Similar Project", action: "external", url: "mailto:info@powertonengineering.com?subject=Project Discussion" },
    ...
    if (option.action === 'external') {
      if (option.url?.startsWith('tel:')) {
        return {
          ...
          options: [
            { label: "📧 Send Email Instead", action: "external", url: "mailto:info@powertonengineering.com" },
            { label: "📍 Visit Our Office", action: "external", url: "https://maps.app.goo.gl/jiap3sBYbM3r8Pn68" },
        ...
        return {
          ...
          options: [
            ...
            { label: "📞 Speak with Expert", action: "external", url: "tel:+91-94627-71662" },
            { label: "📧 Send Us Details", action: "external", url: "mailto:info@powertonengineering.com" },
            { label: "🏠 Back to Main Menu", action: "chat", response: "main-menu" }
          ]
        };
      }
            ...
            <Card className="shadow-2xl border border-gray-200 dark:border-gray-600 h-full flex flex-col overflow-hidden">
              <CardHeader className="bg-primary text-white rounded-t-lg py-4 px-4 flex-shrink-0">
                <CardTitle className="flex items-center justify-center gap-2 text-lg font-medium leading-none">
                  ...
                  <span className="flex-1 text-center">{t('messages.engineeringAdvisor')}</span>
                </CardTitle>
              </CardHeader>
              ...
              <CardContent className="flex-1 flex flex-col p-0 overflow-hidden">
                ...
                <div className="p-3 border-t border-gray-200 dark:border-gray-600 flex-shrink-0 bg-background">
                  <div className="flex gap-2">
                    <Input
                      placeholder={t('common:placeholders.askChatbot')}
                      value={inputValue}
