  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    try {
      ...
      toast({
        ...
        description: t('contact.messages.errorDesc', { phone: FRONTEND_CONFIG.company.phone, email: FRONTEND_CONFIG.company.email }),
        duration: 6000,
      });
    }
  ...
  return (
    <Card className="text-foreground">
      <CardContent className="p-6">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 contact-form">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder={t('contact.fields.serviceType.placeholder')} />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
