                ...
                return (
                  <React.Fragment key={item.name}>
                    ...
                    >
                      ...
                      <div className="fixed left-1/2 -translate-x-1/2 w-max max-w-[95vw] max-h-[70vh] bg-popover border border-border rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 overflow-y-auto" style={{top: `calc(${headerHeight}px - 1rem)`}}>
