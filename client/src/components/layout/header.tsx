                ...
                return (
                  <React.Fragment key={item.name}>
                    ...
                    >
                      ...
                      <div className="fixed left-1/2 -translate-x-1/2 w-[95vw] sm:w-[85vw] md:w-[75vw] lg:w-[65vw] xl:w-[55vw] max-w-6xl bg-popover border border-border rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50" style={{top: `${headerHeight}px`}}>
                        <div className="p-4">
