...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 flex flex-col sm:flex-row sm:justify-between items-center gap-2 sm:gap-0 text-xs md:text-sm">
          <motion.div
