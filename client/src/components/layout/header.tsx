                ...
                return (
                  <React.Fragment key={item.name}>
                    ...
                    >
                      ...
                      <div className="fixed left-1/2 -translate-x-1/2 w-[98vw] sm:w-[95vw] md:w-[92vw] lg:w-[90vw] xl:w-[88vw] max-w-none bg-popover border border-border rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50" style={{top: `calc(${headerHeight}px - 1rem)`}}>
                        <div className="p-4">
