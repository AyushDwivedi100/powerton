                ...
                return (
                  <React.Fragment key={item.name}>
                    ...
                    >
                      ...
                      {/* Hover Dropdown Content */}
                      <div className="opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 absolute top-full z-50 mt-6" style={{left: '50vw', transform: 'translateX(-50%)'}}>
