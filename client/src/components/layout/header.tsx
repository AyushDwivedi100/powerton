...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 flex flex-row justify-center sm:justify-between items-center gap-4 sm:gap-0 text-sm md:text-sm">
          <motion.div
          ...
          >
            ...
            >
              <Mail
                ...
                aria-hidden="true"
              />
              <span className="hidden md:inline whitespace-nowrap text-sm md:text-sm">
                {COMPANY_INFO.email}
              </span>
