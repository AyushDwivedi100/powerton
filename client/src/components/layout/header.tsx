                ...
                return (
                  <React.Fragment key={item.name}>
                    ...
                    >
                      ...
                      {/* Hover Dropdown Content */}
                      <div className="opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 absolute top-full left-1/2 -translate-x-1/2 z-50 mt-6">
