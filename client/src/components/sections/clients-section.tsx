      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-secondary font-semibold text-lg">
            {t('pages:home.clients.label', 'Our Clients')}
          </span>
          <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-primary mt-4 mb-6">
            {t('pages:home.clients.title', 'Trusted By Leading Brands and Organizations')}
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto">
            {t('pages:home.clients.description', "We've partnered with industry leaders across various sectors to deliver exceptional engineering solutions.")}
          </p>
        </div>
        ...
        <div className="text-center mb-12">
          <h3 className="text-2xl font-bold text-primary mb-8">
            {t('pages:home.clients.testimonialsTitle', 'What Our Clients Say')}
          </h3>
        </div>
