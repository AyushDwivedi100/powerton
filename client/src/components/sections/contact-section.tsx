    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          <span className="text-secondary font-semibold text-lg">{t('pages:home.contact.label')}</span>
          <h2 id="contact-heading" className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mt-3 sm:mt-4 mb-4 sm:mb-6">
            {t('pages:home.contact.title')}
          </h2>
          <p id="contact-description" className="text-sm sm:text-base md:text-lg lg:text-xl opacity-90 max-w-3xl mx-auto px-2 sm:px-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          <div>
            <h3 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8" id="contact-info-heading">{t('pages:home.contact.getInTouch')}</h3>
            
            <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8" role="list" aria-labelledby="contact-info-heading">
              ...
              <div className="flex items-start space-x-4" role="listitem">
                ...
                <div>
                  <h4 className="font-semibold mb-2">{t('pages:home.contact.methods.email.title')}</h4>
                  <p className="opacity-90">{COMPANY_INFO.email}</p>
                  <p className="text-sm opacity-70">{t('pages:home.contact.methods.email.description')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4" role="listitem">
                ...
                <div>
                  <h4 className="font-semibold mb-2">{t('pages:home.contact.methods.address.title')}</h4>
                  <a
                  ...
                  <p className="text-sm opacity-70">{t('pages:home.contact.methods.address.metro')}: {COMPANY_INFO.address.landmark}</p>
                </div>
              </div>
            </div>

            <motion.div 
              className="relative overflow-hidden rounded-xl p-6 bg-gradient-to-br from-white/95 to-blue-50/80 dark:from-slate-800/95 dark:to-slate-700/90 shadow-lg border border-slate-200/60 dark:border-slate-600/50"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="font-bold text-primary dark:text-white">{t('common:labels.businessHours')}</h4>
                </div>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between items-center py-2 px-3 bg-white/50 dark:bg-slate-700/50 rounded-lg backdrop-blur-sm">
                    <span className="font-medium text-gray-700 dark:text-gray-300">{t('common:labels.mondayToSaturday')}:</span>
                    <span className="font-semibold text-primary dark:text-emerald-400">{t('common:labels.workingHours')}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 px-3 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/30 dark:to-red-900/30 rounded-lg">
                    <span className="font-medium text-gray-700 dark:text-gray-300">{t('common:labels.sunday')}:</span>
                    <span className="font-semibold text-orange-600 dark:text-orange-400">{t('common:labels.emergencySupport')}</span>
                  </div>
                </div>
              </div>
            </motion.div>
