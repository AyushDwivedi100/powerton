...
export default function GallerySection() {
  ...
  const categoryColors = {
    [t('pages:gallery.categories.electricalSystems')]: "bg-primary/10 text-primary border-primary/20",
    [t('pages:gallery.categories.automation')]: "bg-secondary/10 text-secondary border-secondary/20",
    [t('pages:gallery.categories.safetyProtection')]: "bg-destructive/10 text-destructive border-destructive/20",
    [t('pages:gallery.categories.renewableEnergy')]: "bg-accent/10 text-accent-foreground border-accent/20",
    [t('pages:gallery.categories.measurementSystems')]: "bg-primary/15 text-primary border-primary/30",
    [t('pages:gallery.categories.mechanicalSystems')]: "bg-secondary/15 text-secondary border-secondary/30"
  };
    ...
    <section className="py-12 md:py-16 lg:py-20 bg-muted/30" role="main">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          <span className="text-secondary font-semibold text-responsive-sm">{t('pages:gallery.section.label')}</span>
        ...
        <div className="bg-background border border-border rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 mb-8 sm:mb-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-center">
            <div>
              ...
              <div className="text-foreground/70 text-xs sm:text-sm lg:text-base">{t('pages:gallery.stats.projectsCompleted')}</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary mb-1 sm:mb-2">
