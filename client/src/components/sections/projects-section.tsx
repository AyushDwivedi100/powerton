...
import { PROJECTS, getProjects } from "@/data/constants";
    ...
    <section id="projects" className="py-12 md:py-16 lg:py-20 bg-muted" role="main">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-secondary font-semibold text-lg">{t('pages:home.projects.label', 'Our Projects')}</span>
          <h2 className="text-3xl lg:text-5xl font-bold text-primary mt-4 mb-6">
            {t('pages:home.projects.title', 'Successfully Delivered Engineering Solutions')}
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            {t('pages:home.projects.description', 'Explore our portfolio of completed projects showcasing our expertise in industrial automation and electrical engineering.')}
          </p>
        </div>
            ...
            >
              ...
              <CardContent className="p-8 flex-1 flex flex-col">
                <div className="flex items-center mb-4">
                  ...
                  >
                    {t(`common:projectCategories.${project.category}`, project.category)}
                  </Badge>
                  <span className="text-muted-foreground text-sm">{t('pages:home.projects.completed', 'Completed')} {project.year}</span>
                </div>
                ...
                {/* Project Highlights */}
                <div className="mb-6">
                  <h4 className="text-sm font-semibold text-foreground mb-2">{t('pages:home.projects.keyFeatures', 'Key Features:')}</h4>
