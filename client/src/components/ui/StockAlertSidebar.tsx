  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={onToggle}
          className="fixed left-0 top-[30%] z-50 bg-primary text-primary-foreground px-1.5 py-7 rounded-r-xl shadow-2xl group transition-all hover:bg-primary/90 hover:px-2 hover:shadow-3xl flex flex-col items-center gap-2 border-r border-t border-b border-primary-foreground/20"
