...
export const PROJECTS = [
  {
    ...
    description: "Demonstration of complete manufacturing automation capabilities including PLC integration, SCADA systems, and real-time monitoring solutions.",
    ...
    highlights: ["PLC Integration", "SCADA Systems", "Real-time Monitoring", "Process Optimization"],
    results: {
  ...
  },
  {
    ...
    description: "Example power distribution system showcasing automated load balancing and remote monitoring capabilities for power generation facilities.",
    ...
    highlights: ["Load Balancing", "Protection Systems", "Energy Management", "Remote Control"],
    results: {
  ...
  },
  {
    ...
    description: "Sample solar tracking automation system demonstrating weather monitoring and grid synchronization capabilities for renewable energy projects.",
    ...
    highlights: ["Grid Synchronization", "Weather Monitoring", "Performance Analytics", "Remote Management"],
    results: {
  ...
  },
  {
    ...
    description: "Demonstration of complete process automation capabilities including safety systems, environmental monitoring, and batch control for industrial applications.",
    location: "Project Site TBD",
    ...
    highlights: ["Safety Integration", "Environmental Monitoring", "Batch Processing", "Compliance Systems"],
    results: {
  ...
  },
  {
    ...
    category: "Process Automation",
    industry: "Manufacturing",
    description: "Ongoing demonstration of smart factory integration showcasing IoT connectivity, predictive maintenance, and data-driven optimization for modern manufacturing.",
    ...
    technologies: ["Industrial IoT", "Predictive Analytics", "Edge Computing", "Digital Twins"],
    highlights: ["IoT Integration", "Predictive Maintenance", "Data Analytics", "Digital Transformation"],
    results: {
...
export const getProjectsByStatus = (status: string) => PROJECTS.filter(project => project.status === status);
