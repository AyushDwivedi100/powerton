...
export const getProducts = (t: any) => [
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        description: t(
          "products:subcategories.signal-conditioners.description",
        ),
      },
    ],
  },
  ...
  },
  {
    ...
    features: [
      t(
        "products:categories.measurement-instruments.features.digital-multimeters",
      ),
      t("products:categories.measurement-instruments.features.oscilloscopes"),
      t(
        "products:categories.measurement-instruments.features.signal-analyzers",
      ),
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        description: t(
          "products:subcategories.mounting-structures-racking.description",
        ),
      },
      {
        ...
        description: t(
          "products:subcategories.solar-charge-controllers.description",
        ),
      },
      {
        ...
        description: t(
          "products:subcategories.solar-batteries-energy-storage.description",
        ),
      },
    ],
  },
  ...
  },
  {
    ...
    features: [
      ...
      t(
        "products:categories.industrial-tools-tackles.features.lifting-equipment",
      ),
...
export const getServiceOptions = (t: any) => [
  ...
  },
  {
    ...
    label: t("services:items.maintenance-repair"),
  },
  {
...
export const SERVICES = [
  ...
  },
  {
    ...
    description:
      "Comprehensive preventive and emergency maintenance services for electrical systems, control panels, and industrial automation equipment. 2-hour emergency response time guaranteed.",
    icon: "wrench",
  ...
  },
  {
    ...
    description:
      "NABL-certified precision calibration and testing services for pressure, temperature, flow instruments and control systems. Maintains ±0.25% accuracy standards.",
    icon: "gauge",
    duration: "2-5 days",
    features: [
    ...
    subcategories: [
      {
        ...
        title: "Sensors",
        description:
          "Temperature, pressure, position, and motion sensors for industrial automation",
      },
      {
        id: "transmitters",
        title: "Transmitters & Transducers",
        description:
          "Signal conversion and transmission devices for measurement applications",
      },
      {
        id: "controllers",
        title: "Controllers & Recorders",
        description:
          "Process controllers and data recording systems for industrial control",
      },
      {
        id: "switches",
      ...
      },
      {
        ...
        description:
          "Signal processing and conditioning equipment for measurement systems",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        description:
          "Structural mounting solutions for solar panel installations",
      },
      {
        id: "solar-charge-controllers",
