import { LucideIcon, Cpu, Monitor, Settings, Database, Fan, Wind, Droplet, Zap, Cable, Shield, Power, Wrench, Drill, Scissors, Construction, HardHat, Thermometer, Radio, ToggleLeft, Gauge, FlaskConical, BarChart3, Search, Activity, RotateCcw, Sun, Home, Battery, ShieldCheck, AlertTriangle } from 'lucide-react';
...
export const productCategoriesData: ProductCategoryData[] = [
  {
    ...
    description: 'Advanced automation and control solutions for industrial process management and optimization',
    ...
    cta: {
      ...
      description: "Our automation engineers can design and implement comprehensive control systems for your facility.",
  ...
  },
  {
    ...
    description: 'Energy-efficient brushless DC motor solutions for industrial and commercial applications',
    backgroundImage: bldcBgImage,
    badges: ['BLDC Motors', 'Energy Efficient', 'Low Maintenance', 'Smart Control'],
    ...
    subcategories: [
      {
        ...
        description: "High-efficiency motors for cooling and ventilation applications",
        icon: Wind,
      ...
      },
      {
        ...
        description: "Smart ceiling fans with advanced energy-saving technology",
        icon: Fan,
    ...
    cta: {
      ...
      description: "Our BLDC specialists can help you transition to energy-efficient brushless DC motor solutions.",
  ...
  },
  {
    ...
    badges: ['Power Distribution', 'Control Systems', 'Safety Components', 'Industrial Grade'],
    ...
    cta: {
      ...
      description: "Our electrical engineers can help you select the right components for your power distribution and control systems.",
      contactButtonText: "Contact Our Experts"
    }
  },
  {
    slug: 'industrial-tools-tackles',
    title: 'Industrial Tools & Tackles',
    description: 'Professional tools and equipment for industrial maintenance, construction, and manufacturing operations',
    backgroundImage: industrialToolsImage,
    badges: ['Hand Tools', 'Power Tools', 'Lifting Equipment', 'Safety Gear'],
    ...
    cta: {
      ...
      description: "Our tool specialists can recommend the right equipment for your industrial applications.",
      contactButtonText: "Contact Tool Experts"
    }
  },
  {
    ...
    badges: ['Pressure Transmitters', 'Temperature Sensors', 'Flow Meters', 'Level Indicators'],
    ...
    subcategories: [
      {
        id: "sensors",
        title: "Sensors",
        description: "Industrial sensors for temperature, pressure, and flow measurement",
        icon: Thermometer,
        features: ["Temperature Sensors", "Pressure Sensors", "Flow Sensors", "Level Sensors"]
      },
      {
        id: "transmitters",
        title: "Transmitters",
        description: "Signal transmitters for industrial process measurement",
        icon: Radio,
    ...
    cta: {
      ...
      description: "Our technical experts can help you select the right instrumentation components for your industrial applications.",
  ...
  },
  {
    ...
    badges: ['Digital Multimeters', 'Oscilloscopes', 'Signal Analyzers', 'Calibrators'],
    sectionTitle: 'Product Categories',
    gridCols: 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3',
    subcategories: [
      {
    ...
    cta: {
      title: "Need Measurement Solutions?",
      description: "Our measurement specialists can help you select the right instruments for your application.",
      contactButtonText: "Contact Experts"
    }
  },
  {
    slug: 'mechanical-pumps-spares',
    title: 'Mechanical Pumps & Spares',
    description: 'Industrial pumping solutions and replacement parts for fluid handling applications',
    backgroundImage: pumpSparesImage,
    badges: ['Centrifugal Pumps', 'Diaphragm Pumps', 'Gear Pumps', 'Spare Parts'],
    ...
    cta: {
      ...
      description: "Our pump specialists can help you select the right pumping solution for your application.",
  ...
  },
  {
    ...
    description: 'Comprehensive safety and protective equipment to ensure personnel and equipment safety in industrial environments',
    backgroundImage: safetyEquipmentImage,
    badges: ['Surge Protection', 'Grounding Systems', 'Safety Relays', 'Intrinsic Safety'],
    ...
    cta: {
      ...
      description: "Our safety engineers can assess your facility and recommend comprehensive protective solutions.",
  ...
  },
  {
    ...
    description: 'Complete solar energy solutions including panels, inverters, and energy storage systems',
    ...
    cta: {
      ...
      description: "Our solar experts can design a complete solar energy system tailored to your needs.",
...
export const getCategoryBySlug = (slug: string): ProductCategoryData | undefined => {
