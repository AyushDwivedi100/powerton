...
export const products: Product[] = [
  ...
  // TEST & MEASUREMENT - Real Manufacturer Products
  {
    ...
    description:
      "Professional True-RMS digital multimeter with low-pass filter for VFD measurements. CAT III 1000V rated with 20,000 count display and built-in thermometer.",
    features: [
      "True-RMS for accurate AC measurements",
      "1000V AC/DC voltage measurement",
      "Low-pass filter for VFD applications",
      "CAT III 1000V / CAT IV 600V safety",
      "4½ digit 20,000 count display",
      "Built-in thermometer (80BK probe included)",
    ],
    specs: {
      manufacturer: "Fluke",
      model: "87V",
      series: "87 Series",
      voltage: "1000V AC/DC",
      current: "10A continuous, 20A 30s",
