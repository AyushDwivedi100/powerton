...
export const products: Product[] = [
  ...
  // OSCILLOSCOPES - Real Manufacturer Products
  {
    id: "tektronix-tbs2074b-oscilloscope",
    slug: "tektronix-tbs2074b-digital-storage-oscilloscope",
    categoryKey: "industrial-measuring-tools",
    subcategoryKey: "oscilloscopes",
    typeKey: "digital-oscilloscopes",
    image: "digital-oscilloscope",
    title: "Tektronix TBS2074B Digital Storage Oscilloscope",
    description:
      "70 MHz, 4-channel digital storage oscilloscope with 9-inch WVGA display, 2 GS/s sample rate, and 5M point record length. Ideal for education and embedded design with 5-year warranty.",
    features: [
      "70 MHz bandwidth, 4 analog channels",
      "2 GS/s sample rate, 5M point record length",
      "9-inch WVGA display (15 horizontal divisions)",
    ...
    specs: {
      ...
      channels: "4 analog",
      sampleRate: "2 GS/s",
      recordLength: "5M points",
      display: "9-inch WVGA",
      warranty: "5 years",
    },
  },
  {
    id: "tektronix-tbs2104b-oscilloscope",
    slug: "tektronix-tbs2104b-100mhz-oscilloscope",
    categoryKey: "industrial-measuring-tools",
    subcategoryKey: "oscilloscopes",
    typeKey: "digital-oscilloscopes",
    image: "digital-oscilloscope",
    title: "Tektronix TBS2104B 100MHz Digital Oscilloscope",
    description:
      "100 MHz, 4-channel digital storage oscilloscope with HelpEverywhere guidance system, FFT analysis, and USB/Ethernet connectivity for embedded design and education.",
    features: [
      "100 MHz bandwidth, 4 channels",
      "2 GS/s sample rate across all channels",
      "HelpEverywhere built-in guidance",
      "FFT spectral analysis",
      "USB 2.0 and Ethernet connectivity",
      "Fan-cooled for reliability",
    ],
    specs: {
      manufacturer: "Tektronix",
      model: "TBS2104B",
      ...
      channels: "4 analog",
      sampleRate: "2 GS/s",
      connectivity: "USB, Ethernet, Wi-Fi option",
      application: "Education, embedded design",
      cooling: "Fan-cooled",
    },
  },
  {
    id: "tektronix-mso44b-mixed-signal-oscilloscope",
    slug: "tektronix-mso44b-4-series-mixed-signal-oscilloscope",
    categoryKey: "industrial-measuring-tools",
    subcategoryKey: "oscilloscopes",
    typeKey: "mixed-signal-oscilloscopes",
    image: "mixed-signal-oscilloscope",
    title: "Tektronix MSO44B 4 Series Mixed Signal Oscilloscope",
    description:
      "Professional mixed signal oscilloscope with 4 FlexChannels, 200 MHz to 1.5 GHz bandwidth (upgradeable), 13.3-inch Full HD touchscreen, and up to 48 digital channels capability.",
    features: [
      "4 FlexChannels (analog or 8 digital each)",
      "200 MHz - 1.5 GHz bandwidth (upgradeable)",
      "6.25 GS/s real-time sample rate",
      "13.3-inch Full HD capacitive touchscreen",
      "31.25M point record length (upgradeable)",
      "25+ protocol decode options",
    ],
    specs: {
      manufacturer: "Tektronix",
      model: "MSO44B",
      series: "4 Series B MSO",
      bandwidth: "200 MHz - 1.5 GHz",
      channels: "4 FlexChannel",
      digitalChannels: "Up to 48 digital",
      sampleRate: "6.25 GS/s",
      display: "13.3-inch Full HD touch",
      application: "Professional R&D",
    },
  },
  {
    id: "tektronix-mso46b-6-channel-oscilloscope",
    slug: "tektronix-mso46b-6-channel-mixed-signal-oscilloscope",
    categoryKey: "industrial-measuring-tools",
    subcategoryKey: "oscilloscopes",
    typeKey: "mixed-signal-oscilloscopes",
    image: "mixed-signal-oscilloscope",
    title: "Tektronix MSO46B 6-Channel Mixed Signal Oscilloscope",
    description:
      "Advanced 6 FlexChannel mixed signal oscilloscope with spectrum view, built-in 50 MHz AFG, and advanced triggering for complex mixed-signal debugging in R&D environments.",
    features: [
      "6 FlexChannels for maximum flexibility",
      "Spectrum View frequency domain",
      "Optional 50 MHz arbitrary function generator",
      "Advanced serial protocol decode",
      "12-bit High Res mode",
      "500K+ waveforms/sec capture rate",
    ],
    specs: {
      manufacturer: "Tektronix",
      model: "MSO46B",
      series: "4 Series B MSO",
      bandwidth: "200 MHz - 1.5 GHz",
      channels: "6 FlexChannel",
      captureRate: "500K+ waveforms/sec",
      afg: "Optional 50 MHz",
      resolution: "8-bit / 12-bit High Res",
      application: "Advanced R&D, mixed-signal",
    },
  },
