...
export const productGroups: ProductGroup[] = [
  ...
  },
  {
    ...
    description:
      "Advanced plasma cutting systems for precision metal cutting and fabrication. Features include SYNC cartridge technology, SmartSYNC automated setup, RFID-enabled consumables tracking, and professional-grade cutting performance for steel, stainless steel, and aluminum. Available in various amperage ratings from 30A to 125A for different material thicknesses and applications.",
    subcategoryKey: "cutting-tools",
    image: "plasma-cutter",
    featuredSpecs: ["manufacturer", "model", "amperage"],
  },
...
export const products: Product[] = [
  ...
  // PLASMA CUTTERS SUBCATEGORY PRODUCTS
  {
    id: "hypertherm-powermax45-sync",
    slug: "hypertherm-powermax45-sync",
    categoryKey: "industrial-measuring-tools",
    subcategoryKey: "cutting-tools",
    typeKey: "plasma-cutters",
    image: "plasma-cutter",
    datasheetUrl: "https://www.hypertherm.com/hypertherm/powermax/powermax45-sync/",
    specs: {
      manufacturer: "Hypertherm",
      model: "Powermax45 SYNC",
      amperage: "45A",
      cuttingCapacity: "Up to 32mm (1-1/4\") recommended",
      features: "RFID SmartSYNC, cartridge system",
      consumableLife: "Up to 5x longer",
    },
    title: "Hypertherm Powermax45 SYNC",
    description: "Revolutionary 45 amp plasma cutter with single-piece cartridge system and RFID-enabled SmartSYNC torches. Features automated setup, up to 5x longer consumable life, and versatile cutting, gouging, and marking capabilities.",
    features: [
      "45 amp cutting capacity to 32mm",
      "SmartSYNC RFID-enabled torches",
      "Single-piece cartridge consumable system",
      "Up to 5x longer consumable life",
      "Automated process setup",
      "Hand cutting, mechanized cutting, gouging, marking",
    ],
  },
  {
    id: "hypertherm-powermax65-sync",
    slug: "hypertherm-powermax65-sync",
    categoryKey: "industrial-measuring-tools",
    subcategoryKey: "cutting-tools",
    typeKey: "plasma-cutters",
    image: "plasma-cutter",
    datasheetUrl: "https://www.hypertherm.com/hypertherm/powermax/powermax65-sync/",
    specs: {
      manufacturer: "Hypertherm",
      model: "Powermax65 SYNC",
      amperage: "65A",
      cuttingCapacity: "Up to 20mm (3/4\") recommended",
      features: "Cartridge platform, automated setup",
      applications: "Handheld and mechanized",
    },
    title: "Hypertherm Powermax65 SYNC",
    description: "Professional-grade 65 amp plasma cutter with revolutionary cartridge platform and automated process setup. Color-coded consumables with RFID tracking for optimal performance in handheld and mechanized cutting and gouging.",
    features: [
      "65 amp professional-grade system",
      "Up to 20mm cutting capacity",
      "Revolutionary cartridge platform",
      "Color-coded consumable identification",
      "Automated process setup",
      "Handheld and mechanized capable",
    ],
  },
  {
    id: "hypertherm-powermax85-sync",
    slug: "hypertherm-powermax85-sync",
    categoryKey: "industrial-measuring-tools",
    subcategoryKey: "cutting-tools",
    typeKey: "plasma-cutters",
    image: "plasma-cutter",
    datasheetUrl: "https://www.hypertherm.com/hypertherm/powermax/powermax85-sync/",
    specs: {
      manufacturer: "Hypertherm",
      model: "Powermax85 SYNC",
      amperage: "85A",
      cuttingCapacity: "Up to 25mm (1\") recommended",
      features: "Cartridge system, SmartSYNC",
      applications: "Professional fabrication",
    },
    title: "Hypertherm Powermax85 SYNC",
    description: "85 amp professional plasma cutting system with cartridge platform technology. Features SmartSYNC automated setup, real-time diagnostics, and versatile handheld and mechanized cutting and gouging for demanding fabrication work.",
    features: [
      "85 amp professional cutting capacity",
      "Up to 25mm (1 inch) cutting thickness",
      "SmartSYNC cartridge platform",
      "Real-time consumable diagnostics",
      "End-of-life consumable detection",
      "Handheld and mechanized cutting/gouging",
    ],
  },
  {
    id: "hypertherm-powermax105-sync",
    slug: "hypertherm-powermax105-sync",
    categoryKey: "industrial-measuring-tools",
    subcategoryKey: "cutting-tools",
    typeKey: "plasma-cutters",
    image: "plasma-cutter",
    datasheetUrl: "https://www.hypertherm.com/hypertherm/powermax/powermax105-sync/",
    specs: {
      manufacturer: "Hypertherm",
      model: "Powermax105 SYNC",
      amperage: "105A",
      cuttingCapacity: "Up to 32mm (1-1/4\") recommended",
      features: "Heavy-duty cartridge system",
      dutyCycle: "Professional grade",
    },
    title: "Hypertherm Powermax105 SYNC",
    description: "Heavy-duty 105 amp plasma cutting system with professional-grade cartridge platform. Features automated setup, RFID tracking, up to 32mm cutting capacity, and robust construction for demanding industrial applications.",
    features: [
      "105 amp heavy-duty capacity",
      "Up to 32mm recommended cutting",
      "Professional cartridge platform",
      "RFID-enabled consumable tracking",
  ...
  },
  {
    ...
    slug: "hypertherm-powermax125",
    categoryKey: "industrial-measuring-tools",
    subcategoryKey: "cutting-tools",
    typeKey: "plasma-cutters",
    image: "plasma-cutter",
    datasheetUrl: "https://www.hypertherm.com/hypertherm/powermax/powermax125/",
    specs: {
      manufacturer: "Hypertherm",
      model: "Powermax125",
      amperage: "125A",
      cuttingCapacity: "Up to 57mm (2-1/4\")",
      pierceCapacity: "25mm (1\") mechanized",
      dutyCycle: "100%",
    },
    title: "Hypertherm Powermax125",
    description: "Maximum power 125 amp air plasma cutting system with up to 57mm cutting capacity. Features Smart Sense technology, 100% duty cycle, and exceptional cutting performance for heavy-duty industrial metal cutting and gouging.",
    features: [
      "125 amp maximum power output",
      "Up to 57mm (2-1/4 inch) cutting capacity",
      "25mm mechanized pierce capacity",
      "100% duty cycle rating",
      "Smart Sense technology",
      "Fast metal removal and gouging",
    ],
  },
  {
    id: "hypertherm-powermax30-xp",
    slug: "hypertherm-powermax30-xp",
    categoryKey: "industrial-measuring-tools",
    subcategoryKey: "cutting-tools",
    typeKey: "plasma-cutters",
    image: "plasma-cutter",
    datasheetUrl: "https://www.hypertherm.com/hypertherm/powermax/powermax30-xp/",
    specs: {
      manufacturer: "Hypertherm",
      model: "Powermax30 XP",
      amperage: "30A (25A at 120V)",
      inputVoltage: "Dual voltage 120V/240V",
      features: "FineCut consumables, portable",
      applications: "Thin to thick metal",
    },
    title: "Hypertherm Powermax30 XP",
    description: "Versatile 30 amp dual-voltage plasma cutter for thin to thick metal cutting. Features FineCut consumables for precision work, portable design, and flexible 120V/240V operation for shop or field applications.",
    features: [
      "30 amp dual-voltage operation",
      "25A at 120V, 30A at 240V",
      "FineCut consumables for thin metal",
      "Portable lightweight design",
      "Wide range thin to thick cutting",
      "Shop and field versatility",
    ],
  },
