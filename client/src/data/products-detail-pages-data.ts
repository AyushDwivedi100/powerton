...
export const products: Product[] = [
  ...
  // PROCESS ANALYZERS - Real Manufacturer Products
  {
    id: "siemens-siprocess-ga700",
    slug: "siemens-siprocess-ga700-gas-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "process-analyzers",
    image: "process-analyzer",
    title: "Siemens SIPROCESS GA700 Gas Analyzer",
    description:
      "Latest generation extractive continuous process gas analyzer with modular flexible design for process monitoring, control, optimization, and quality control applications.",
    features: [
      "Modular and flexible design",
      "High precision and reliability",
      "Multiple gas measurement capability",
      "HART communication protocol",
      "SIL 2 certification available",
      "Easy calibration and maintenance",
    ],
    specs: {
      manufacturer: "Siemens",
      model: "SIPROCESS GA700",
      series: "SIPROCESS",
      type: "Extractive continuous gas analyzer",
      application: "Process monitoring and control",
      communication: "HART, Modbus, Profibus",
      certification: "ATEX, IECEx, SIL 2",
      mounting: "Wall/Panel mount",
    },
  },
  {
    id: "siemens-ultramat-23",
    slug: "siemens-ultramat-23-gas-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "process-analyzers",
    image: "process-analyzer",
    title: "Siemens ULTRAMAT 23 Gas Analyzer",
    description:
      "Compact NDIR gas analyzer for continuous measurement of up to 3 IR-active gas components. Ideal for combustion control, emissions monitoring, and process optimization.",
    features: [
  ...
  {
    id: "abb-ao2020-laser-analyzer",
    slug: "abb-ao2020-process-gas-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "process-analyzers",
    image: "process-analyzer",
    title: "ABB AO2020 Tunable Diode Laser Analyzer",
    description:
      "In-situ process gas analyzer using tunable diode laser spectroscopy for real-time moisture, oxygen, and hydrocarbon measurement in various industrial processes.",
    features: [
      "TDL spectroscopy technology",
      "In-situ measurement (no sampling)",
      "Fast response time (<1 second)",
      "No consumables required",
      "Wide temperature range operation",
      "HART, Modbus, Profibus support",
    ],
    specs: {
      manufacturer: "ABB",
      model: "AO2020",
      series: "Laser Analyzers",
      type: "TDL in-situ analyzer",
      technology: "Tunable Diode Laser",
      application: "Moisture, O2, hydrocarbons",
      temperature: "-40 to 300°C",
      communication: "HART, Modbus, Profibus",
    },
  },
  {
    id: "yokogawa-gc8000-gas-chromatograph",
    slug: "yokogawa-gc8000-process-gas-chromatograph",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "process-analyzers",
    image: "process-analyzer",
    title: "Yokogawa GC8000 Process Gas Chromatograph",
    description:
      "High-performance process gas chromatograph for continuous online analysis of complex gas mixtures. Ideal for refinery, petrochemical, and natural gas applications.",
    features: [
      "Multi-stream analysis capability",
      "Advanced oven control technology",
      "Modular detector configuration",
    ...
    specs: {
      ...
      streams: "Up to 16 streams",
      application: "Oil & gas, petrochemical",
      communication: "Modbus, Profibus, HART",
      certification: "SIL 2, ATEX, IECEx",
    },
  },

  // GAS ANALYZERS - Real Manufacturer Products
  {
    id: "emerson-ct5800-gas-analyzer",
    slug: "emerson-rosemount-ct5800-continuous-gas-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "gas-analyzers",
    image: "gas-analyzer",
    title: "Emerson Rosemount CT5800 Continuous Gas Analyzer",
    description:
      "Hybrid QCL/TDL gas analyzer for hazardous areas, measuring up to 10 gases simultaneously with sub-ppm to percent level detection. Features flameproof enclosure and Class I Div 2 certification.",
    features: [
      "Hybrid QCL/TDL technology",
      "Measures up to 10 gases simultaneously",
      "Sub-ppm to percent level range",
      "Class I Div 2 hazardous area certified",
    ...
    specs: {
      manufacturer: "Emerson",
      model: "CT5800",
      series: "Rosemount Continuous Gas Analyzer",
      type: "Quantum Cascade Laser / TDL",
      gases: "Up to 10 gases",
      range: "Sub-ppm to percent levels",
      hazardousArea: "Class I Div 2",
      application: "Gas purity, quality control",
    },
  },
  {
    id: "emerson-ct4400-nox-analyzer",
    slug: "emerson-rosemount-ct4400-nox-gas-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "gas-analyzers",
    image: "gas-analyzer",
    title: "Emerson Rosemount CT4400 NOx Gas Analyzer",
    description:
      "Hybrid QCL/TDL analyzer optimized for nitrogen oxide emissions and continuous emissions monitoring systems. Rack-mount design with sub-second response time.",
    features: [
      "NOx and CEMS optimized",
      "Measures up to 7 gases",
    ...
    specs: {
      manufacturer: "Emerson",
      model: "CT4400",
      series: "Rosemount QCL Analyzer",
      type: "Hybrid QCL/TDL",
      gases: "Up to 7 gases",
      response: "Sub-second",
      application: "NOx emissions, CEMS",
      communication: "HART, Modbus",
    },
  },
  {
    id: "thermofisher-43iq-so2-analyzer",
    slug: "thermofisher-43iq-sulfur-dioxide-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "gas-analyzers",
    image: "gas-analyzer",
    title: "Thermo Fisher 43iQ SO₂ Analyzer",
    description:
      "Pulsed fluorescence SO₂ analyzer with smart monitoring and predictive diagnostics. Features 7-inch touchscreen, standard range to 1000 ppm, extended to 10,000 ppm.",
    features: [
      "Pulsed fluorescence technology",
      "7-inch color touchscreen",
      "Predictive diagnostics",
      "Range: 0-1000 ppm (std), 0-10,000 ppm (ext)",
      "Modbus and Ethernet support",
      "Email notifications",
    ],
    specs: {
      ...
      model: "43iQ",
      series: "iQ Series",
      type: "Pulsed fluorescence",
      gas: "Sulfur dioxide (SO₂)",
      range: "0-1000 ppm / 0-10,000 ppm",
      communication: "Modbus, Ethernet",
      application: "Ambient & source monitoring",
    },
  },
  {
    id: "thermofisher-42iq-nox-analyzer",
    slug: "thermofisher-42iq-nitrogen-oxide-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "gas-analyzers",
    image: "gas-analyzer",
    title: "Thermo Fisher 42iQ NOx Analyzer",
    description:
      "Chemiluminescence NOx analyzer for real-time nitrogen oxide monitoring. High-level variant measures 10-5000 ppm for emissions and ambient monitoring applications.",
    features: [
      "Chemiluminescence detection",
      "High-level: 10-5000 ppm",
      "Real-time NO/NOx monitoring",
      "7-inch touchscreen interface",
      "Smart monitoring with diagnostics",
      "Modbus/Ethernet connectivity",
    ],
    specs: {
      manufacturer: "Thermo Fisher Scientific",
      model: "42iQ",
      ...
      range: "10-5000 ppm",
      application: "Emissions, ambient NOx",
      communication: "Modbus, Ethernet",
    },
  },
  {
    id: "thermofisher-maxir-ftir-analyzer",
    slug: "thermofisher-maxir-ftir-gas-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "gas-analyzers",
    image: "gas-analyzer",
    title: "Thermo Fisher MAX-iR FTIR Gas Analyzer",
    description:
      "FTIR gas analyzer with VCSEL laser and 24-bit ADC for single-digit ppb detection. Features StarBoost enhanced optics and long-life components for in-line process monitoring.",
    features: [
      "FTIR with VCSEL laser technology",
      "24-bit ADC for high resolution",
      "Single-digit ppb detection",
      "StarBoost enhanced optics",
    ...
    specs: {
      manufacturer: "Thermo Fisher Scientific",
      model: "MAX-iR",
      series: "FTIR Gas Analyzer",
      type: "Fourier Transform Infrared",
      sensitivity: "Single-digit ppb",
      technology: "VCSEL laser, 24-bit ADC",
      application: "Process, emissions, ambient air",
      gases: "Multiple gases simultaneously",
    },
  },
  {
    id: "siemens-oxymat-6-oxygen-analyzer",
    slug: "siemens-oxymat-6-paramagnetic-oxygen-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "gas-analyzers",
    image: "gas-analyzer",
    title: "Siemens OXYMAT 6 Oxygen Analyzer",
    description:
      "Paramagnetic oxygen analyzer for continuous O₂ measurement in combustion processes, inert gas production, and quality control applications. Range: 0-100% O₂.",
    features: [
      "Paramagnetic measuring principle",
      "Range: 0-100% O₂",
      "Fast response time",
    ...
    specs: {
      ...
      gas: "Oxygen (O₂)",
      range: "0-100%",
      application: "Combustion, inert gas",
      accuracy: "±0.5% of measured value",
    },
  },
  {
    id: "abb-easyline-clo2-analyzer",
    slug: "abb-easyline-chlorine-dioxide-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "gas-analyzers",
    image: "gas-analyzer",
    title: "ABB EasyLine ClO₂ Analyzer",
    description:
      "Continuous chlorine dioxide gas analyzer for water treatment and disinfection monitoring. Amperometric measurement with 0-2 ppm standard range.",
    features: [
      "Amperometric measurement",
      "Range: 0-2 ppm (standard)",
      "Continuous monitoring",
      "Low maintenance design",
      "4-20 mA output",
  ...
  {
    id: "yokogawa-zr402g-oxygen-analyzer",
    slug: "yokogawa-zr402g-zirconia-oxygen-analyzer",
    categoryKey: "instrumentation-accessories",
    subcategoryKey: "analyzers",
    typeKey: "gas-analyzers",
    image: "gas-analyzer",
    title: "Yokogawa ZR402G Zirconia Oxygen Analyzer",
    description:
      "In-situ zirconia oxygen analyzer for combustion control in boilers, furnaces, and kilns. Direct insertion probe with 0-25% O₂ measurement range.",
    features: [
      "Zirconia sensor technology",
      "In-situ direct insertion",
      "Range: 0-25% O₂",
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          ...
          "thermofisher-42iq-nox-analyzer",
          "thermofisher-maxir-ftir-analyzer",
