...
export const FRONTEND_CONFIG = {
  ...
  forms: {
    ...
    fallbackEmail: 'info.powerton@gmail.com',
  ...
  chatbot: {
    ...
    fallbackMessage: "For detailed assistance, please contact our team at +91-94627-71662 or info.powerton@gmail.com"
  },
...
export const canSubmitForms = () => {
  ...
  return !!(config.serviceId && config.publicKey && config.templateIds.contact && config.templateIds.quote);
};
