...
class RouteRegistry {
  ...
  getPublicRoutes(): RouteInfo[] {
    return Array.from(this.routes.values()).filter(route => !route.hideFromSitemap);
  }
...
export function initializeRoutes(): void {
  const routes: RouteInfo[] = [
    ...
    // Measurement Instruments Subcategories
    {
      ...
      category: "product-subcategories",
      icon: "Zap",
      parentRoute: "/products/measurement-instruments"
    },
    {
    ...
    // Industrial Tools Subcategories
    {
      ...
      category: "product-subcategories",
      icon: "Hammer",
      parentRoute: "/products/industrial-tools-tackles"
    },
    {
