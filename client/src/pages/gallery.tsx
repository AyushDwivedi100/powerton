...
export default function Gallery() {
  ...
  const productImages = [
    {
      id: 1,
      title: t('gallery.products.images.instrumentation.title'),
      description: t('gallery.products.images.instrumentation.description'),
      category: t('gallery.products.categories.instrumentation'),
      brand: t('products:brands.fluke')
    },
    {
      id: 2,
      title: t('gallery.products.images.controlSystems.title'),
      description: t('gallery.products.images.controlSystems.description'),
      category: t('gallery.products.categories.controlSystems'),
      brand: t('products:brands.siemens')
    },
    {
      id: 3,
      title: t('gallery.products.images.solarProducts.title'),
      description: t('gallery.products.images.solarProducts.description'),
      category: t('gallery.products.categories.solar'),
      brand: t('products:brands.abb')
    },
    {
      id: 4,
      title: t('gallery.products.images.instrumentation.title'),
      description: t('gallery.products.images.instrumentation.description'),
      category: t('gallery.products.categories.instrumentation'),
      brand: t('products:brands.honeywell')
    },
    {
      id: 5,
      title: t('gallery.products.images.electricalPanels.title'),
      description: t('gallery.products.images.electricalPanels.description'),
      category: t('gallery.products.categories.electricalPanels'),
      brand: t('products:brands.customBuilt')
    },
    {
      id: 6,
      title: t('gallery.products.images.controlSystems.title'),
      description: t('gallery.products.images.controlSystems.description'),
      category: t('gallery.products.categories.controlSystems'),
      brand: t('products:brands.wonderware')
    },
    {
      id: 7,
      title: t('gallery.products.images.pumps.title'),
      description: t('gallery.products.images.pumps.description'),
      category: t('gallery.products.categories.pumps'),
      brand: t('products:brands.grundfos')
    },
    {
      id: 8,
      title: t('gallery.products.images.safetyEquipment.title'),
      description: t('gallery.products.images.safetyEquipment.description'),
      category: t('gallery.products.categories.safety'),
      brand: "3M, MSA"
    }
  ];
  ...
  const ImageCard = ({ image, type }: { image: any, type: 'company' | 'projects' | 'products' }) => (
    ...
    >
      <Card className="group bg-card border border-border overflow-hidden cursor-pointer">
      <div className="relative">
        {/* Placeholder for actual image */}
        <div className="w-full h-48 bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center">
          <div className="text-center p-4">
            <ZoomIn className="w-8 h-8 text-primary mx-auto mb-2" />
            <p className="text-sm text-muted-foreground">{t('products:gallery.imagePlaceholder')}</p>
            <p className="text-xs text-muted-foreground mt-1">{t('products:gallery.actualImages')}</p>
          </div>
        </div>
          ...
          <AnimatedSection animation="fadeInUp" delay={0.1} duration={0.8}>
            ...
            <div className="flex justify-center gap-4 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{t('common:buttons.successfulProjects', 'Successful Projects')}</span>
              </div>
              <div className="flex items-center gap-2">
                <Package className="w-5 h-5 text-secondary" />
                <span>{t('common:buttons.qualityProducts', 'Quality Products')}</span>
              </div>
            </div>
          </AnimatedSection>
        </div>
