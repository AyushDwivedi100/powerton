...
export default function NewsArticle() {
  ...
  const article = {
    ...
    content: `
      ...
      <ul>
        <li>${t('news.article.sampleArticle.content.achievements.costReduction')}</li>
        <li>${t('news.article.sampleArticle.content.achievements.efficiency')}</li>
      ...
      <h3>${t('news.article.sampleArticle.content.technicalImplementation')}</h3>
      ...
      <ul>
        ...
        <li>${t('news.article.sampleArticle.content.technologies.maintenance')}</li>
    ...
    tags: [t('products:tags.industrialAutomation'), t('products:tags.plcSystems'), t('products:tags.scada'), t('products:tags.manufacturing'), t('products:tags.processOptimization')],
  ...
  const getCategoryColor = (category: string) => {
    const colors: Record<string, string> = {
      [t('news.article.categories.projectSuccess')]: "bg-primary/10 text-primary border-primary/20",
      [t('news.article.categories.technology')]: "bg-accent/10 text-accent-foreground border-accent/20",
      [t('news.article.categories.industryNews')]: "bg-secondary/10 text-secondary border-secondary/20",
      [t('news.article.categories.companyUpdate')]: "bg-primary/20 text-primary border-primary/30"
    };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Related Articles */}
          <div className="mt-12">
            <h3 className="text-2xl font-semibold text-foreground mb-6">{t('news.article.relatedArticles.title')}</h3>
