...
const BLDCCoolerExhaustMotorPage = () => {
  const products = [
    {
      name: "BLDC Exhaust Fan Motors",
      description: "High-efficiency motors for exhaust fan applications",
      features: ["Variable Speed", "Low Noise", "Energy Efficient", "Long Life"],
image: getProductImageSrc('bldc-cooler-exhaust-motor')
    },
    {
      name: "BLDC Cooler Motors",
      description: "Energy-efficient motors for air cooler applications",
      features: ["High Torque", "Weather Resistant", "Speed Control", "Maintenance Free"],
image: getProductImageSrc('bldc-cooler-exhaust-motor')
    },
    {
      name: "BLDC Ventilation Motors",
      description: "Specialized motors for industrial ventilation systems",
      features: ["High CFM", "Temperature Rated", "Vibration Resistant", "Smart Control"],
image: getProductImageSrc('bldc-cooler-exhaust-motor')
    }
  ];
      ...
      <section className="relative py-12 md:py-16 lg:py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">BLDC Cooler & Exhaust Motors</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Energy-efficient BLDC motors for cooling, ventilation, and exhaust applications
            </p>
