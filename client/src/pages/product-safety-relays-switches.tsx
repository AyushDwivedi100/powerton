    ...
    <div className="min-h-screen bg-background">
      <div className="relative bg-gradient-to-br from-primary/10 via-primary/5 to-background py-20">
        <div 
          ...
          style={{ backgroundImage: `url(${safetyEquipmentImage})` }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Safety Relays & Switches</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Safety relays and switches for machine safety and personnel protection systems
            </p>
            <div className="flex flex-wrap justify-center gap-2 mb-8">
              <Badge variant="secondary">Emergency Stop</Badge>
              <Badge variant="secondary">Light Curtains</Badge>
              <Badge variant="secondary">Safety Switches</Badge>
              <Badge variant="secondary">Category 3/4</Badge>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-foreground text-center mb-12">Safety Device Solutions</h2>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-foreground mb-6">Need Machine Safety Solutions?</h2>
          <p className="text-lg text-muted-foreground mb-8">Our safety specialists can design comprehensive safety systems to protect personnel and equipment.</p>
...
export default SafetyRelaysSwitchesPage;