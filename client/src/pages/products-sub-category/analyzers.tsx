...
export default function ProductAnalyzers() {
  ...
  const product = {
    title: t('products:productPages.analyzers.product.title'),
    shortDescription: t('products:productPages.analyzers.product.shortDescription'),
    fullDescription: t('products:productPages.analyzers.product.fullDescription'),
    image: analyzersBgImage,
    keyBenefits: [
      t('products:productPages.analyzers.product.keyBenefits.processControl'),
      t('products:productPages.analyzers.product.keyBenefits.productQuality'),
      t('products:productPages.analyzers.product.keyBenefits.compliance'),
      t('products:productPages.analyzers.product.keyBenefits.safety')
    ],
    specifications: [
  ...
  return (
    <>
      <SEO
        ...
        keywords={t('products:productPages.analyzers.seo.keywords', 'process analyzers, gas analyzers, liquid analyzers, pH analyzers, conductivity meters, gas chromatography, process monitoring')}
      ...
      <section className="relative hero-fullscreen overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: `url(${analyzersBgImage})`
          }}
        />
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold">
                {t('products:productPages.analyzers.title')}
              </h1>
            </div>
            <p className="text-lg md:text-xl mb-8 opacity-90 max-w-3xl mx-auto">
              {t('products:productPages.analyzers.subtitle')}
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection animation="fade-in-left">
              <img 
                src={product.image}
                alt={t('products:productPages.analyzers.product.altText', `ID-842: ${product.title} - Industrial gas and liquid process analyzers`)}
            ...
            <AnimatedSection animation="fade-in-right">
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-6">
                {t('products:productPages.analyzers.sections.overview.title', 'Advanced Process Analysis')}
              </h2>
              ...
              <div className="flex gap-4">
                ...
                <Link href="/contact">
                  <Button variant="outline">
                    {t('products:productPages.analyzers.buttons.consultation', 'Analysis Consultation')}
                  </Button>
                </Link>
              </div>
            </AnimatedSection>
          ...
          <AnimatedSection animation="fade-in-up">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
                {t('products:productPages.analyzers.sections.technologies.title', 'Analysis Technologies')}
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                {t('products:productPages.analyzers.sections.technologies.description', 'Advanced measurement technologies for precise process analysis')}
              </p>
            </div>
          </AnimatedSection>
                ...
                <Card className="h-full">
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-medium text-foreground mb-2">{t('products:productPages.analyzers.labels.technologies', 'Technologies:')}</h4>
                      ...
                      <div>
                        <h4 className="font-medium text-foreground mb-2">{t('products:productPages.analyzers.labels.parameters', 'Parameters:')}</h4>
                        <ul className="space-y-1">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <AnimatedSection animation="fade-in-up">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
                {t('products:productPages.analyzers.sections.specifications.title', 'Technical Specifications')}
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                {t('products:productPages.analyzers.sections.specifications.description', 'Precision specifications for reliable process monitoring')}
              </p>
            </div>
          </AnimatedSection>
              ...
              <Card className="h-full">
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-foreground">{t('products:productPages.analyzers.labels.specifications', 'Specifications')}</h3>
                  </div>
                  <div className="space-y-4">
              ...
              <Card className="h-full">
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-foreground">{t('products:productPages.analyzers.labels.applications', 'Applications')}</h3>
                  </div>
                  <div className="space-y-4">
              ...
              <Card className="h-full">
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-foreground">{t('products:productPages.analyzers.labels.industries', 'Industries')}</h3>
                  </div>
                  <div className="space-y-4">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 text-center">
          <AnimatedSection animation="fade-in-up">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              {t('products:productPages.analyzers.cta.title', 'Need Process Analysis Solutions?')}
            </h2>
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              {t('products:productPages.analyzers.cta.description', 'Our process analysis experts can help you select the right analyzers for your monitoring and compliance requirements.')}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4 max-w-md mx-auto">
              <Link href="/contact">
                <Button className="bg-secondary hover:bg-secondary/90 text-secondary-foreground px-8 py-3 text-lg font-semibold w-full sm:w-auto">
                  <Phone className="mr-2 w-5 h-5" />
                  {t('products:productPages.analyzers.cta.button', 'Analysis Expert')}
                </Button>
              </Link>
              <Link href="/quote">
                <Button 
