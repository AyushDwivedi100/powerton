        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-8">
              ...
              <Badge variant="secondary">{t('products:badges.polycrystalline', 'Polycrystalline')}</Badge>
              <Badge variant="secondary">{t('products:badges.bifacial', 'Bifacial')}</Badge>
              <Badge variant="secondary">{t('products:badges.highEfficiency', 'High Efficiency')}</Badge>
            </div>
          </div>
        </div>
      </div>
