    ...
    <>
      ...
      <section className="relative hero-fullscreen overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: `url(${transmittersImage})`
          }}
        />
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold">
                <span className="text-secondary">{t('products:productPages.transmitters.title', 'Transmitters')}</span> & {t('products:productPages.transmitters.transducers', 'Transducers')}
              </h1>
            </div>
              ...
              <Card className="h-full">
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-foreground">{t('products:labels.specifications', 'Specifications')}</h3>
                  </div>
              ...
              <Card className="h-full">
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-foreground">{t('products:labels.applications', 'Applications')}</h3>
                  </div>
                  <div className="space-y-4">
              ...
              <Card className="h-full">
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-foreground">{t('products:labels.industries', 'Industries')}</h3>
                  </div>
                  <div className="space-y-4">
