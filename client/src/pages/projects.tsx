...
const PORTFOLIO_PROJECTS = [
  {
    ...
    year: 2024,
    description:
      "Complete automation of steel manufacturing process with PLC integration, SCADA systems, and real-time monitoring.",
    ...
    image:
      "https://images.unsplash.com/photo-1565300075136-f58d3cb0a9b7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2000&q=80",
  ...
  },
  {
    ...
    year: 2024,
    description:
      "Advanced power distribution system with automated load balancing and remote monitoring capabilities.",
    technologies: [
      "MCC Panels",
      "Protection Systems",
      "Energy Management",
    ...
    image:
      "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2000&q=80",
  ...
  },
  {
    ...
    year: 2023,
    description:
      "Automated solar tracking system with weather monitoring and grid synchronization.",
    technologies: [
      "Solar Inverters",
      "Grid Sync",
      "Weather Monitoring",
  ...
  },
  {
    ...
    year: 2024,
    description:
      "Complete process automation for chemical refinery with safety systems and environmental monitoring.",
    technologies: [
      "Process Control",
      "Safety Systems",
    ...
    image:
      "https://images.unsplash.com/photo-1582478686849-df4aca7a4ce0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2000&q=80",
    category: "Process Automation",
  },
  {
    id: 5,
    ...
    year: 2023,
    description:
      "Automated water treatment plant with quality monitoring and distribution control systems.",
    technologies: [
    ...
    image:
      "https://images.unsplash.com/photo-1581092160607-ee22621dd758?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2000&q=80",
  ...
  },
  {
    ...
    year: 2023,
    description:
      "Automated food processing line with quality control and packaging automation.",
    technologies: [
      "Conveyor Systems",
      "Quality Control",
    ...
    image:
      "https://images.unsplash.com/photo-1586953208448-b95a79798f07?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2000&q=80",
    category: "Process Automation",
  },
];
...
export default function Projects() {
  ...
  const stats = [
    { number: 1200, suffix: "+", label: t('common:company.stats.projectsCompleted', 'Projects Completed'), icon: Award },
    { number: 450, suffix: "+", label: t('common:company.stats.clientsServed', 'Happy Clients'), icon: Users },
    { number: 15, suffix: "+", label: t('common:company.stats.yearsExperience', 'Years Experience'), icon: Calendar },
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 lg:px-8 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base md:text-lg mb-6 sm:mb-8 opacity-90">
              {t('pages:projects.hero.subtitle', 'Discover our engineering excellence through 1200+ successful projects across diverse industries, showcasing innovation, quality, and reliability.')}
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From power generation to manufacturing automation, explore how
              we've delivered innovative engineering solutions across various
              industries.
            </p>
          </div>
          ...
          >
            <TabsList className="grid w-full grid-cols-2 max-w-md mx-auto mb-8">
              <TabsTrigger value="portfolio">{t('ui.projectPortfolio')}</TabsTrigger>
              <TabsTrigger value="showcase">{t('ui.featuredProjects')}</TabsTrigger>
            </TabsList>
                      ...
                      <div className="min-w-0">
                        ...
                        >
                          <SelectTrigger className="w-full">
                            <SelectValue placeholder={t('common:placeholders.selectIndustryFilter')} />
                          </SelectTrigger>
                          <SelectContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProjects.map((project, index) => {
                  ...
                  return (
                    <Card
                      key={project.id}
                      className={`bg-card border border-border rounded-lg p-8 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all duration-300 cursor-pointer ${getAnimationClass("fade-in-up", true)}`}
                    >
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 text-center">
          ...
          <p className="text-base md:text-lg text-white mb-8 max-w-2xl mx-auto opacity-90">
            ...
            industrial automation project to life.
          </p>
