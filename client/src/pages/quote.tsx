                ...
                <div className="absolute inset-0 bg-background/80 backdrop-blur-sm z-50 rounded-lg flex items-center justify-center">
                  <div className="text-center p-8 max-w-md">
                    ...
                    <p className="text-lg text-muted-foreground mb-6">
                      We're putting the finishing touches on our intelligent
                      cost estimation tool. This feature will provide instant,
                      accurate pricing for your automation projects.
                    </p>
