        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => {
              ...
              return (
                <Card key={index} className="bg-card border border-border rounded-lg p-6 shadow-sm hover:shadow-md text-center hover:scale-[1.02] transition-all duration-300">
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              variant="outline" 
              className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground border-white text-white hover:bg-background hover:text-foreground px-6 py-3 rounded-lg font-semibold transition-all"
