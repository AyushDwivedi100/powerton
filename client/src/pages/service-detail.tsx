...
const serviceDetails = {
  "installation-commissioning": {
    overview: "Professional installation and commissioning services for electrical panels, control systems, and industrial equipment with complete system validation and performance optimization.",
    benefits: [
    ...
    technologies: ["Electrical Panels", "Control Systems", "SCADA Integration", "Safety Systems", "Performance Testing"],
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative py-12 md:py-16 lg:py-20 overflow-hidden">
          <div 
            ...
            style={{ 
              backgroundImage: `url(${getServiceHeroImage(serviceId as keyof typeof serviceDetails)?.src})`,
              filter: 'blur(2px)'
            }}
          ></div>
                  ...
                  <Card className="mb-8">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Monday - Saturday, Emergency support available</p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-foreground mb-2">Coverage</h4>
                        <p className="text-muted-foreground">Pan-India service coverage</p>
                      </div>
                    </CardContent>
                  </Card>
                </AnimatedSection>
                ...
                <AnimatedSection animation="fadeInLeft" delay={0.7}>
                  <Card>
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-muted-foreground mb-4">Contact us for a detailed consultation and customized solution.</p>
        ...
        <section className="py-16 bg-muted/50">
          <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {SERVICES.filter(s => s.id !== serviceId).slice(0, 3).map((relatedService, index) => {
