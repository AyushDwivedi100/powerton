...
export default function MaintenanceRepair() {
  ...
  const translationKey = "maintenanceRepair"; // Convert kebab-case to camelCase for translation
  const details = {
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative py-12 md:py-16 lg:py-20 overflow-hidden">
          <div 
            ...
            style={{ 
              backgroundImage: `url(${getServiceHeroImage("maintenance-repair")?.src})`,
        ...
        <section className="py-16 bg-muted/50">
          <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {SERVICES.filter(s => s.id !== "maintenance-repair").slice(0, 3).map((relatedService, index) => {
