                ...
                return (
                  <AnimatedSection key={service.id} animation="fadeInUp" delay={0.3 + index * 0.1}>
                    <Link href={`/services/${service.id}`}>
                      <Card className="h-full hover:shadow-xl transition-all duration-300 cursor-pointer group border-border">
                        ...
                        <CardContent>
                          ...
                          <Button variant="ghost" className="text-secondary hover:text-secondary/80 p-0 group-hover:translate-x-2 transition-transform">
