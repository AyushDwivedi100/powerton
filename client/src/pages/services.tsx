                ...
                return (
                  ...
                  >
                    <Link href={`/services-category/${service.id}`}>
                      <Card className="w-full h-full hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 cursor-pointer group border-border flex flex-col relative overflow-hidden">
                        {/* Popular Badge */}
                        {service.popular && (
